...
class AnalysisEngine:
    ...
    def analyze_video(self, video_path: str | Path, output_dir: str | Path, manual_go_time: float | None) -> AnalysisResult:
        video_path = Path(video_path)
        output_dir = Path(output_dir)
        output_dir.mkdir(parents=True, exist_ok=True)

        pose_sequence = self.pose_estimator.extract(video_path)
